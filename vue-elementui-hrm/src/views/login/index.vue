<template>
  ...
  <div class="main-w3layouts wrapper">
    ...
    <div class="main-agileinfo">
      <div class="agileits-top">
        <el-form :rules="rules" :model="staff" ref="loginForm">
          <input style="color:white" class="text" type="text" placeholder="Username" required="" v-model.trim="staff.code">
          <input style="color:white" class="text" type="password"  placeholder="Password" required="" v-model.trim="staff.password">
    ...
    <div class="w3copyright-agile">
      <p>© 2024 HRM Login Form . All rights <a href="http://www.bootstrapmb.com/" title="bootstrapmb">Reserved</a>
      </p>
    </div>
    <!-- //copyright -->
          ...
          login(this.staff).then(
            response => {
              if (response.code === 200) {
                ...
                this.$store.commit('token/SET_TOKEN', 'Bearer' + response.token) // 存储token
...
body {
  font-family:Verdana;
  background: #1779dc;
  background: -webkit-linear-gradient(to bottom right, #1779dc 50%, #1b55e8 50%);
  background: linear-gradient(to bottom right, #1779dc 50%, #1b55e8 50%);
